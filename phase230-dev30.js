(()=>{
  const VERSION='3.0.0-transfer-screenshot-import31';
  ...
  function afterCommit(){setTimeout(()=>{try{window.h2h300SyncHornHistoryIntoTransfers?.()}catch(e){console.warn('Horn table sync',e)}try{window.h2h300SyncAllDerivedState?.({reason:'ai-transfer-import',render:true})}catch(e){console.warn('Internal state sync',e)}},650)}
