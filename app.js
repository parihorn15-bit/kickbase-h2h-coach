...
function competition(){
  ...
  return `<div class="league-redesign">
    <section class="card screenshot-import-card">
      <div class="screenshot-import-copy"><span class="eyebrow">KICKBASE 2.0.7</span><h3>AI Screenshot Import · 2.0.7</h3><p>Wähle einen oder mehrere Kickbase-Screenshots. Sie werden zunächst nur analysiert und als Vorschau angezeigt.</p></div>
