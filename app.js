...
document.addEventListener('click',e=>{
  ...
  if(status)status.textContent=`Indexiert ${diag.masterCount} Master-Spieler · ${diag.matches.filter(x=>x.match!=='—').length}/${diag.matches.length} Diagnose-Nachnamen erkannt…`;
  setTimeout(()=>{
