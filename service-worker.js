const CACHE_NAME='h2h-coach-cloud-v230fulluse1';
const CORE=[
  './',
  './index.html',
  './styles.css?v=215n',
  ...
  event.waitUntil(
    caches.keys()
      ...
      .then(async()=>{
        ...
        for(const client of clients) client.postMessage({type:'APP_UPDATED',version:'2.3.0-test-fulluse1'});
      })
  );
});
