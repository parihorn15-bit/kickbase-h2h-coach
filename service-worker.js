const CACHE_NAME='h2h-coach-cloud-v230dev11_7';
const CORE=[
  './',
  './index.html',
  './styles.css?v=215n',
  ...
  './phase230-dev11.js?v=230dev11_6',
  ...
  event.waitUntil(
    caches.keys()
      ...
      .then(async()=>{
        ...
        for(const client of clients) client.postMessage({type:'APP_UPDATED',version:'2.3.0-test-dev11.7'});
      })
  );
});
